...
<head>
    ...
    <title>Gestion des Fournisseurs - ConstructionXpert</title>
...
<body class="bg-gray-100">
        ...
        <div class="flex-1">
            ...
            <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="bg-white shadow rounded-lg mb-6">
                    <div class="p-4">
                        <form class="grid grid-cols-1 gap-4 md:grid-cols-3" id="filterForm">
                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500">
                                            <div class="flex flex-wrap gap-1">
                                                <c:forEach items="${supplier.resources}" var="resource" varStatus="status">
                                                ...
                                                <c:if test="${supplier.resources.size() gt 3}">
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                                        +${supplier.resources.size() - 3}
                                                    </span>
                                                </c:if>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-3">
                                                <button onclick="openSupplierDetailsModal(${supplier.id})" 
    ...
    <div id="newSupplierModal" class="hidden fixed z-10 inset-0 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
            </div>
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form id="newSupplierForm" action="${pageContext.request.contextPath}/admin/suppliers/create" method="POST">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Nouveau Fournisseur</h3>
                        <div class="space-y-4">
                            <div>
    ...
    <script>
        ...
        function openSupplierDetailsModal(supplierId) {
            window.location.href = `${pageContext.request.contextPath}/admin/suppliers/${supplierId}`;
        }

        function openEditSupplierModal(supplierId) {
            window.location.href = `${pageContext.request.contextPath}/admin/suppliers/${supplierId}/edit`;
        }

        function confirmDeleteSupplier(supplierId) {
            if (confirm('Êtes-vous sûr de vouloir supprimer ce fournisseur ?')) {
                window.location.href = `${pageContext.request.contextPath}/admin/suppliers/${supplierId}/delete`;
            }
        }
